...
public class AMQPConfiguration {
    ...
    @Bean
    public Binding correctAttempsBinding(final Queue gamificationQueue,
    ...
    @Bean
    public RabbitListenerConfigurer rabbitListenerConfigurer(final MessageHandlerMethodFactory factory) {
